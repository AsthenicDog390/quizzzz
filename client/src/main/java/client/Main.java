...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        var nameScreen= FXML.load(NameSelectionCtrl.class, "client", "scenes", "NameSelection.fxml");

        var mainCtrl = INJECTOR.getInstance(MainCtrl.class);

        mainCtrl.initialize(primaryStage, overview, add, menu, howToPlay, multipleChoiceSingle, serverLocation, nameScreen);
    }
}