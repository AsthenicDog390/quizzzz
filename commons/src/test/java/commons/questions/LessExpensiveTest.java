...
class LessExpensiveTest {
    ...
    void constructorThrows() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new LessExpensive(new Activity[]{one, two, three, four}, null);
        });
        assertThrows(IllegalArgumentException.class, () -> {
            new LessExpensive(new Activity[]{one, two, null}, null);
        });
        assertThrows(IllegalArgumentException.class, () -> {
            new LessExpensive(new Activity[]{one, two, three}, four);
        });
    }
    ...
    void getOptions() {
        ...
        var q = new LessExpensive(new Activity[]{one, two, three}, three);
